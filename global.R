# Global script for birdForestry project
  ...
  ## Simulation setup
  mySimCONW <- simInit(times = times, params = parameters, modules = modules, paths =  paths, objects = objects)
  mySimOutCONW <- spades(mySimCONW, debug = TRUE) #c("warblersPointCountBC","init")
