...
basicMCMCplots::chainsPlot(samplesList = model3$samples)
basicMCMCplots::chainsSummary(samplesList = model3$samples)
basicMCMCplots::samplesPlot(samples = model3$samples)
```
...
basicMCMCplots::chainsPlot(samplesList = model4$samples)
basicMCMCplots::chainsSummary(samplesList = model4$samples)
basicMCMCplots::samplesPlot(samples = model4$samples)
```
...
## Conclusion: Model X seems better  
