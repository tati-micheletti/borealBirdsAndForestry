...
```{r load1, echo=TRUE}
model1 <- prepInputs(url = "https://drive.google.com/open?id=1yIHt8JE1v3-d8VW_Z6Ypj74NtJ-ZZP5Y",
                     ...
                     destinationPath = file.path(getwd(), "outputs/posthocAnalysis/bayesian/trial3"),
...
```{r load2, echo=TRUE}
model2 <- prepInputs(url = "https://drive.google.com/open?id=15d7j6wBj09a6XK1mF0C3cFLggrrqCao4",
                       # TRIAL2: "https://drive.google.com/open?id=17QiG44vd-Tsf-7QZreUz8Vq67UmpDLZH",
...
```{r load3, echo=TRUE}
model3 <- prepInputs(url = "https://drive.google.com/open?id=1MLKMU-oz7MgnIhJ8XoqLZ_f5ki57SWm2",
...
```{r load4, echo=TRUE}
model4 <- prepInputs(url = "https://drive.google.com/open?id=1HQhyWsSHY8w54yUZPAmnv-Kv-zz-qtj-",
