...
```{r load1, echo=TRUE}
model1 <- prepInputs(url = "https://drive.google.com/open?id=1jS36CdH3jJiVdVXlE6GOkznP4Ao50o5m",
                       #TRIAL 1: "https://drive.google.com/open?id=1jZHlCKP8goQZ1W-nFXcaiBabxSTzEQv4",
                     destinationPath = file.path(getwd(), "outputs/posthocAnalysis/bayesian/trial2"),
...
```{r load2, echo=TRUE}
model2 <- prepInputs(url = "https://drive.google.com/open?id=17QiG44vd-Tsf-7QZreUz8Vq67UmpDLZH",
...
```{r load3, echo=TRUE}
model3 <- prepInputs(url = "https://drive.google.com/open?id=1oVzMYvI7YXvL6TsgSh8BnYCda7GOAU2E",
                       # TRIAL1: "https://drive.google.com/open?id=1UWoaLN1lNOjVQBSzSD2WpA1185i1x9ne",
                     destinationPath = file.path(getwd(), "outputs/posthocAnalysis/bayesian/trial2"),
...
```{r load4, echo=TRUE}
model4 <- prepInputs(url = "https://drive.google.com/open?id=1yMFNbIF7aPm6nmaqrjnz4518BsO6644L",
