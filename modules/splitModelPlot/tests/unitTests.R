...
test_dir("C:/Ian/Tati/borealBirdsAndForestry/modules/splitModelPlot/tests/testthat")

# Alternative, you can use test_file to test individual test file, e.g.:
test_file("C:/Ian/Tati/borealBirdsAndForestry/modules/splitModelPlot/tests/testthat/test-template.R")
