...
# devtools::load_all("/home/tmichele/projects/reproducible") # For debugging
...
# If using parallel, to view messages (in BorealCloud): tail -f /home/tmichele/projects/borealBirdsAndForestry/cache/logParallelFocal
